...
class LinearAmplificationCircuitTest {
    ...
    fun exampleOne() {
        ...
        assertThat(findMaxThrustSignalInLinearConfiguration(compile(program)), equalTo(43210))
    }
    ...
    fun exampleTwo() {
        ...
        assertThat(findMaxThrustSignalInLinearConfiguration(compile(program)), equalTo(54321))
    }

    @Test
    fun exampleThree() {
        val program = "3,31,3,32,1002,32,10,32,1001,31,-2,31,1007,31,0,33,1002,33,7,33,1,33,31,31,1,32,31,31,4,31,99,0,0,0"
        assertThat(findMaxThrustSignalInLinearConfiguration(compile(program)), equalTo(65210))
    }

    @Test
    fun verifyPartOne() {
        val program = AMPLIFIER_CONTROLLER_SOFTWARE
        assertThat(findMaxThrustSignalInLinearConfiguration(compile(program)), equalTo(70597))
