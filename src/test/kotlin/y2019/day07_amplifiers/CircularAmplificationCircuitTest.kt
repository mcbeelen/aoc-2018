...
class CircularAmplificationCircuitTest {
    ...
    fun exampleOne() {
        ...
        assertThat(findMaxThrusterSignalInCircularConfiguration(sourceCode).intValueExact(), equalTo(139629729))
    }
    ...
    fun exampleTwo() {
        ...
        assertThat(findMaxThrusterSignalInCircularConfiguration(sourceCode).intValueExact(), equalTo(18216))
    ...
    fun actualPartTwo() {
        ...
        assertThat(findMaxThrusterSignalInCircularConfiguration(sourceCode).intValueExact(), equalTo(30872528)) // 30872528
    }
