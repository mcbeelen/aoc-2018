...
class CircularAmplificationCircuitTest {
    ...
    fun exampleOne() {
        ...
        assertThat(findMaxThrusterSignalInCircularConfiguration(sourceCode), equalTo(139629729))
    }
    ...
    fun exampleTwo() {
        ...
        assertThat(findMaxThrusterSignalInCircularConfiguration(sourceCode), equalTo(18216))
    ...
    fun actualPartTwo() {
        ...
        assertThat(findMaxThrusterSignalInCircularConfiguration(sourceCode), equalTo(30872528)) // 30872528
    }
